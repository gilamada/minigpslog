...
void Led_RW_ON(void)
{
  GPIO_SetBits(USB_LED_PORT, GPIO_Pin_0);
}
...
{
  GPIO_ResetBits(USB_LED_PORT, GPIO_Pin_0);
}
/*******************************************************************************
...
{
  GPIO_SetBits(USB_LED_PORT, GPIO_Pin_1);
}
...
{
  GPIO_ResetBits(USB_LED_PORT, GPIO_Pin_1);
}
...
//======================================================================
//函 数 名: USB_CheckPlugInit() 
//功    能: 检测USB插入初始化
//入口参数: 无
//出口参数: 无
//返 回 值: 无
//======================================================================
 void USB_CheckPlugInit(void)
{ 			
   GPIO_InitTypeDef GPIO_InitStructure;  
											   

	/* 配置 PA11 USBDM 为上拉输入模式*/
...
//入口参数: 无
//出口参数: 无
//返 回 值: TRUE 插入 FALSE 未插入
//======================================================================
bool USB_CheckPlug(void)
{ 			
    
    if(Bit_RESET == GPIO_ReadInputDataBit(GPIOA, GPIO_Pin_11))
     return TRUE;
    else 
     return FALSE ;
