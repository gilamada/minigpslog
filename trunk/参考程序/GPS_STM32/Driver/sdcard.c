...
//使用24M系统频率时
#define SDIO_INIT_CLK_DIV                  ((u8)0x3b)
#define SDIO_TRANSFER_CLK_DIV              ((u8)0x1) 
...
SD_Error SD_PowerON(void)
{
  ...
  /* Power ON Sequence -------------------------------------------------------*/
  /* Configure the SDIO peripheral */
    if(SystemCoreClock_Mhz == 24)
  {
    SDIO_InitStructure.SDIO_ClockDiv = SDIO_INIT_CLK_DIV; /* HCLK = 24MHz, SDIOCLK = 24MHz, SDIO_CK = HCLK/(60) = 400 KHz */
  }else{
